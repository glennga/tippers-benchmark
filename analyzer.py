""" This file is for generating plots based on the observed data from our observer functions. """
import argparse
import abc
import json
import datetime
...
if __name__ == '__main__':
    ...
    analyzer = _analyzer_factory(args.config_path, args.database)
    analyzer.begin_logging(args.oneshot, args.frequency)
    analyzer.end_logging()
